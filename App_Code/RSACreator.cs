...
/// <summary>
/// Summary description for RSACreator
/// </summary>
public class RSACreator
{
    public static string CreateRSACode(string plaintext)
    {
        RSACryptoServiceProvider RSAalg = new RSACryptoServiceProvider(1024);
        RSAalg.PersistKeyInCsp = false;
        RSAalg.FromXmlString(loadRsaPublicKeyPem());
        RSAalg.KeySize = 1024;
        return Convert.ToBase64String(RSAalg.Encrypt(Convert.FromBase64String(plaintext), true));
    }
    ...
    {
        return "<RSAKeyValue><Modulus>MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCkq3XbDI1s8Lu7SpUBP+bqOs/MC6PKWz6n/0UkqTiOZqKqaoZClI3BUDTrSIJsrN1Qx7ivBzsaAYfsB0CygSSWay4iyUcnMVEDrNVOJwtWvHxpyWJC5RfKBrweW9b8klFa/CfKRtkK730apy0Kxjg+7fF0tB4O3Ic9Gxuv4pFkbQIDAQAB</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>";
    }
