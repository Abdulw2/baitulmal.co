...
public class ImageHelp
{
    ...
    public static System.Drawing.Image HardResizeImage(int Width, int Height, System.Drawing.Image Image)
    {
        ...
        resized = ResizeImage(Width, Height, Image);
        Image iOriginal = Image;
    ...
    public static byte[] ResizeImage(int width, int Height, byte[] byteArrayIn)
    {
        Image img = null;
        ...
        Image imageIn = HardResizeImage(width, Height, img);
