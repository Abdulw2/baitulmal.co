                                        ...
                                        <div class="span_1_of_6 bg-f7f">
                                            ...
                                            <div class="themesflat-content-box clearfix" data-margin="0 10px 0 43px" data-mobilemargin="0 15px 0 15px">
                                                <div class="themesflat-headings style-2 clearfix">
                                                    ...
                                                    <p class="sub-heading margin-top-33 line-height-24">According to the World Bank Kampala May 2023 report, about 30% of Ugandans are poor. In absolute term, the number of poor people increased from 8.03 million to 8.31 million, which needs more attention and more interventions from government and private sector.</p>
                                                </div>
                                            </div>
                                            <div class="themesflat-spacer clearfix" data-desktop="56" data-mobile="56" data-smobile="56"></div>
                                        </div>
                                        <div class="span_1_of_6 half-background style-2" style="background-image: url('/assets/img/poverty.jpg');">
                                        </div>
                                    </div>
                                    <!-- /.themesflat-row -->
