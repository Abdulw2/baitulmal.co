                                ...
                                <div class="themesflat-content-box clearfix" data-margin="0 18px 0 0"
                                    ...
                                    <div class="themesflat-tabs style-1 clearfix">
                                        <ul class="tab-title clearfix">
                                            ...
                                            <li class="item-title">
                                                <span class="inner">Uganda Muslim Education Association (UMEA).</span>
                                            </li>
                                            <li class="item-title">
                                                <span class="inner">Uganda Muslim Teachers' Association (UMTA). </span>
                                            </li>
                                            <li class="item-title">
                                                <span class="inner">The Islamic Medical Association of Uganda
                                                    (IMAU).</span>
                                            </li>
                                            <li class="item-title">
                                                <span class="inner">Bilal Staff Savings and Credit Cooperative Society
                                                    (BISTSACCO)</span>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="tab-content-wrap clearfix">
                                            <div class="tab-content">
                                                <div class="item-content">
                                                    ...
                                                    <p>This is the mother, apex and governing body of Muslims in Uganda,
                                                        who constitute 6.5 million according to Uganda Bureau of
                                                        statistics (UBOS). UMSC structures include; over 9 Regional
                                                        Administrative Structures for easy service delivery and 78
                                                        Muslim Districts, 465 Muslim Counties and over 13,000 Mosque. It
                                                        manages several Muslim-based institutions including; hospitals,
                                                        health centres, Universities, post-secondary institutions,
                                                        secondary schools, primary schools, Uganda Muslim Medical
                                        ...
                                        <div class="tab-content">
                                            <div class="item-content">
                                                <img src="assets/img/Diwan Islamic Finance Agency.png" width="80px"
                                                    style="float:left" />
                                                <p>
                                                    This is a one-stop centre for Islamic finance sector development
                                                    through training, research and publication, and Shari’ah advisory
                                                    services in areas of finance, zakat, waqf, and estate management.
                                                    ...
                                                    position as the top provider of quality training across all major
                                                    Islamic finance disciplines. Diwan agency training arm specializes
                                                    in industry technical certifications. The certifications are
                                                    designed to ensure attainment of technical proficiency levels to
                                                    fulfill jobs requirement and support professionalization of the
                                                    industry. Diwan serves as a partner to numerous world class
                                                    institutions; delivering thought leadership, research, advisory,
                                                    assessment and training in various Islamic finance fields.
                                                </p>
                                                <%--<div
                                                    class="themesflat-list has-icon style-1 icon-left ofset-padding-32 clearfix">
                                                    <div class="inner">
                                    ...
                                    <div class="tab-content">
                                        <div class="item-content">
                                            <img src="assets/img/Uganda Muslim Education Association (UMEA).png"
                                                width="80px" style="float:left" />
                                            <p>This was established in 1936 to work as a Muslim Secretariat that serves
                                                Ugandan Muslims. It aims at providing a platform for Muslims to achieve
                                                sound education (modern and traditional Islamic studies) purposely to
                                                attain a reasonable share in their country as their counterparts of
                                    ...
                                    <div class="tab-content">
                                        <div class="item-content">
                                            <img src="assets/img/Uganda Muslim Teachers' Association (UMTA).png"
                                                width="80px" style="float:left" />
                                            <p>
                                                This is an umbrella body that brings together Muslim teachers in Uganda
                                                so they increase access to quality education of the Muslim community as
                                                well as improving Teachers' welfare. UMTA was established in 1988 as a
                                                national non-governmental not for profit organisation working across the
                                                country. UMTA units Muslim teachers irrespective of their social and
                                    ...
                                    <div class="tab-content">
                                        <div class="item-content">
                                            <img src="assets/img/The Islamic Medical Association of Uganda (IMAU).png"
                                                width="80px" style="float:left" />
                                            <p>This is a registered non-governmental organization established in 1988.
                                                The membership of the Association consists of Muslim health
                                                professionals who form the General Assembly, the association’s highest
                                                authority. IMAU targets all people of Uganda but with a comparative
                                                advantage with Islamic communities. </p>
                                        </div>
                                    </div>
                                    <!-- /.tab-content -->
                                    <div class="tab-content">
                                        <div class="item-content">
                                            ...
                                            <p> SACCOs in Various Institutions.
                                                ...
                                                We establish Islamic financial cooperatives (Baitulmal Wat Tamwil) in
                                                different institutions who are our implementing partners established as
                                                standalone or Windows in conventional financial institutions including;
                                                Cooperatives, Savings and Credit Cooperative Societies (SACCOs), Groups,
                                                Microfinance Institutions (MFIs), Small and Median Enterprises (SMEs),
                                                and other development institutions.
                                                One of the model reference SACCOs we have supported is Bilal Staff
                                                Savings and Credit Cooperative Society (BISTSACCO)
                                            </p>
                                        </div>
                                    </div>
                                    <!-- /.tab-content -->
