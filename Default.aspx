                                ...
                                <div id="rev-slider2" class="rev_slider fullwidthabanner">
                                    <ul>
                                        ...
                                        <li data-transition="random">
                                            ...
                                            <div id="overlay1">
                                                <div style="background-color:rgba(0,0,0,0.5);position:absolute;right:0px;left:0px;bottom:0px;height:100%"></div>
                                            <img src="assets/img/s1.jpg" alt="" data-bgposition="center center" data-no-retina>
                                            </div>
                                            ...
                                            <div class="tp-caption "
                                                ...
                                                data-splitout="none" 
                                                data-responsive_offset="on">
                                                <a href="#" class="themesflat-button bg-accent big"><span>PARTNER WITH US</span></a>
                                            </div>
                                        </li>
                                        <!-- /End Slide 1 -->
                                        ...
                                        <li data-transition="random">
                                            ...
                                            <img src="assets/img/s2.jpg" alt="" data-bgposition="center center" data-no-retina>
                                ...
                                <div class="row-about">
                                    <div class="container">
                                        <div class="row equalize sm-equalize-auto">
                                            <div class="col-md-6 half-background style-1" style="background-image:url('assets/img/about.jpg');">
                                            </div>
                                            <!-- /.col-md-6 -->
                                            <div class="col-md-6 bg-light-grey">
                                                ...
                                                <div class="themesflat-content-box clearfix" data-margin="0 25% 0 4.5%" data-mobilemargin="0 0 0 4.5%">
                                                    ...
                                                    <div class="elm-button">
                                                        <a href="ContactUs.aspx" class="themesflat-button bg-white">PARTNER WITH US</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="themesflat-headings style-1 text-center clearfix">
                                                    ...
                                                    <%--<p class="sub-heading">Guaranteed Sustainable Development through maximization of Islamic finance social impact to the active poor and productive entrepreneurs in the Community.</p>--%>
                                                </div>
                                                <%--<div class="themesflat-spacer clearfix" data-desktop="42" data-mobile="35" data-smobile="35"></div>--%>
                                            </div>
                                            <!-- /.col-md-12 -->
                                                ...
                                                <div class="themesflat-content-box clearfix" data-margin="0 5px 0 5px" data-mobilemargin="0 0 0 0">
                                                    <div class="themesflat-icon-box icon-top align-center has-width w95 circle light-bg accent-color style-1 clearfix">
                                                        ...
                                                        <div class="text-wrap">
                                                            ...
                                                            <div class="sep clearfix"></div>
                                                            <p class="sub-heading">Promoting socially responsible development of the active poor through Islamic Financial Cooperatives/ Baitulmal Wat-Tamwil (BMT) Groups and the productive entrepreneurs.</p>
                                                        </div>
                                                    </div>
                                                    <!-- /.themesflat-icon-box -->
                                                </div>
                                        ...
                                        <%--<div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="elm-button text-center">
                                                    <a href="Objectives.aspx" class="themesflat-button bg-accent">Learn More</a>
                                                </div>
                                                    ...
                                                    <div class="quote-item">
                                                        <div class="inner">
                                                            ...
                                                            <div class="button-wrap has-icon icon-left">
                                                                <a href="#" class="themesflat-button bg-white small"><span>+256 750 075300 <span class="icon"><i class="autora-icon-phone-contact"></i></span></span></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="tab-content-wrap clearfix">
                                                            <div class="tab-content">
                                                                <div class="item-content">
                                                                    <img src="assets/img/umsc.jpg" width="80px"  style="float:left"/>
                                                                    <p>This is the mother, apex and governing body of Muslims in Uganda, who constitute 6.5 million according to Uganda Bureau of statistics (UBOS). UMSC structures include; over 9 Regional Administrative Structures for easy service delivery and 78 Muslim Districts, 465 Muslim Counties and over 13,000 Mosque. It manages several Muslim-based institutions including; hospitals, health centres, Universities, post-secondary institutions, secondary schools, primary schools, Uganda Muslim Medical Bureau, radio and TV stations among others.</p>
                                                                </div>
                                                            </div>
                                                            <!-- /.tab-content -->
                                                            <div class="tab-content">
                                                                <div class="item-content">
                                                                    ...
                                                                    <p>This is a non-denominational and not for profit organization set up to manage and administer Zakat (obligatory dues) and preservation of Waqf (endowment) in accordance with the teaching of the Holy Quran, Hadith, Consensus and Analogy for the social wellbeing of Muslims and development of Islam.</p>
                                                            ...
                                                            <div class="tab-content">
                                                                <div class="item-content">
                                                                    ...
                                                                    <p>
                                                                        This is a one-stop centre for Islamic finance sector development through training, research and publication, and Shari’ah advisory services in areas of finance, zakat, waqf, and estate management.
Diwan agency plays a vital role in the development of Islamic finance industry in Uganda through advisory, training and development of Human capital in the field of Islamic finance and Shari’ah. Diwan’s commitment to excellence has strengthened its position as the top provider of quality training across all major Islamic finance disciplines.
Diwan agency training arm specializes in industry technical certifications. The certifications are designed to ensure attainment of technical proficiency levels to fulfil jobs requirement and support professionalization of the industry. Diwan serves as a partner to numerous world class institutions; delivering thought leadership, research, advisory, assessment and training in various Islamic finance fields.
                                                                    </p>
                                                                    <%--<div class="themesflat-list has-icon style-1 icon-left ofset-padding-32 clearfix">
                                                                    <div class="inner">
                                                                        <span class="item">
