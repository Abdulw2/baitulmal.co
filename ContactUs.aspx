                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="themesflat-headings style-1 text-center clearfix">
                                                    ...
                                                    <p class="sub-heading font-weight-400 max-width-770 line-height-26 margin-top-14">Are you interested in finding out how Baitulmal can support sustainable development? For more information please contact us.</p>
                                                </div>
                                        ...
                                        <div class="row gutter-16">
                                            <div class="col-md-4">
                                                <div class="themesflat-icon-box icon-top align-center  accent-color style-3 bg-light-snow clearfix">
                                                    ...
                                                    <div class="text-wrap">
                                                        <h5 class="heading"><a href="#">+256 750 075300</a></h5>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="themesflat-icon-box icon-top align-center accent-color style-3 bg-light-snow clearfix">
                                                    ...
                                                    <div class="text-wrap">
                                                        <h5 class="heading"><a href="#">Plot 9, Parryman Garden, Old Kampala</a></h5>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="themesflat-icon-box icon-top align-center accent-color style-3 bg-light-snow clearfix">
                                                    ...
                                                    <div class="text-wrap">
                                                        <h5 class="heading"><a href="#">info@baitulmal.org.co</a></h5>
                                                        <p class="sub-heading">Support 24/7 - Online 24 hours</p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="themesflat-contact-form style-2 w100 clearfix">
                                                    <form id="contactform" action="http://corpthemes.com/html/autora/contact/contact-process2.php" method="post" class="contact-form wpcf7-form">
                                            ...
                                            <!-- /.col-md-6 -->
                                            <div class="col-md-8">
                                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7979.515158126388!2d32.559388586568744!3d0.3161575742464004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x177dbb629b5a25b7%3A0xe02763524a70dfa!2sOld%20Kampala%2C%20Kampala!5e0!3m2!1sen!2sug!4v1707203242527!5m2!1sen!2sug" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </div>
                                            <!-- /.col-md-6 -->
                                        </div>
                                        <!-- /.row -->
